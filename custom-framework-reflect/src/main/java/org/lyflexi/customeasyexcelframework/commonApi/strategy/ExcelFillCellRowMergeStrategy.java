package org.lyflexi.customeasyexcelframework.commonApi.strategy;
...
public class ExcelFillCellRowMergeStrategy implements CellWriteHandler {
    ...
    private void mergeWithPrevRow(WriteSheetHolder writeSheetHolder, Cell cell, int curRowIndex, int curColIndex) {
        Object curData = ObjectUtil.equal(cell.getCellTypeEnum(), CellType.STRING) ? cell.getStringCellValue() : cell.getNumericCellValue();
        ...
        Object preData = null;
        if(ObjectUtil.equal(cell.getCellTypeEnum(), CellType.STRING) || ObjectUtil.equal(cell.getCellTypeEnum(), CellType.BLANK)){
