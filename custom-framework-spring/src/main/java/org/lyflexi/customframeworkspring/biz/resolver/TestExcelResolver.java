package org.lyflexi.customframeworkspring.biz.resolver;

import com.fasterxml.jackson.databind.ObjectMapper;
import lombok.extern.slf4j.Slf4j;
import org.lyflexi.customframeworkspring.biz.service.ITestExcelService;
...
import org.lyflexi.customframeworkspring.commonApi.resolver.AbstractExcelResolver;
import org.lyflexi.customframeworkspring.commonApi.vo.ExcelErrorResultVo;
...
public class TestExcelResolver extends AbstractExcelResolver<TestExcelEntity> {
    ...
    @Autowired
    private ITestExcelService iTestExcelService;
...
//            }
    ...
    protected void saveAllDataForImport(List<TestExcelEntity> toSaveList) {
        log.info("解析的导入数据toSaveList = {}",toSaveList);
        log.info("excel入库成功");
    }
}
